...
function adicionarLinhaTabela(objeto) {
    ...
    tr.innerHTML = "<td>" + objeto.nome + "</td>" +
        ...
        "<td><button style ='padding:5px' type='button' class='btn btn-danger' onclick='deletarLinha(this)'><i class='fas fa-trash-alt'></i></button></td>";
...
function deletarLinha(linha) {
    ...
    toastr.error('Aluno excluido com sucesso!');
}
